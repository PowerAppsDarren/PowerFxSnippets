...
### By Technology
- **Power Fx**: [View all Power Fx functions](#power-fx-functions)
- **UDFs**: [View all user-defined functions](#udf-functions)
- **Algorithms**: [View all algorithm implementations](#algorithms)

### By Use Case
- **Data Processing**: [View processing functions](#data-processing)
- **Text Manipulation**: [View text functions](#text-manipulation)
- **Calculations**: [View math functions](#math-functions)

### By Feature
- **Validation**: [View validation functions](#validation)
- **Transformation**: [View transformation functions](#transformation)
- **Optimization**: [View performance functions](#optimization)
