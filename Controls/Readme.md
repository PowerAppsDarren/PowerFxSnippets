...
If you ever need a listing of all the controls available in Power Apps, here is a snippet you can paste in App.Formulas. It is an expressionthat will return a table of all the controls available in Power Apps.
