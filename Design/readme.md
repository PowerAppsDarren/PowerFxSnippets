...
| [**Fluent UI Themes**](./design.md) | Microsoft design system | 🟡 |
| [**Theme Designer**](./design.md) | Theme creation tools | 🟡 |
...
#### 🔴 Expert Level
- [**Design Architecture**](./design.md) - System design
...
**Key Snippets:**
- [**Design Principles**](./design.md) - Core concepts
- [**UX Guidelines**](./design.md) - User experience basics
...
**Key Snippets:**
- [**Fluent UI Themes**](./design.md) - Microsoft theming
- [**Theme Designer**](./design.md) - Theme creation tools
- [**Custom Themes**](./design.md) - Personalized theming
...
**Key Snippets:**
- [**UI Patterns**](./design.md) - Interface patterns
- [**Interaction Design**](./design.md) - User interactions
...
### By Technology
- **Fluent UI**: [View Fluent patterns](#fluent-ui)
- **Themes**: [View theming systems](#themes)
- **UX**: [View UX principles](#ux)

### By Use Case
- **Branding**: [View brand design](#branding)
- **Mobile**: [View mobile design](#mobile)
- **Web**: [View web design](#web)

### By Feature
- **Colors**: [View color systems](#colors)
- **Typography**: [View text design](#typography)
- **Layout**: [View layout patterns](#layouts)
...
2. Implement [**Advanced Theming**](./design.md)
3. Create [**Custom Patterns**](./design.md)
...
- [**UI Design**](https://learn.microsoft.com/en-us/power-apps/guidance/planning/design-principles) - Design concepts
...
### Latest Additions
- [**Fluent UI Integration**](./design.md) - Added 2025-12-17 - Microsoft design system
- [**Theme Designer Tools**](./design.md) - Added 2025-12-17 - Theme creation
- [**Design Principles**](./design.md) - Added 2025-12-17 - Core concepts
