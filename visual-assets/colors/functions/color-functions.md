---
title: Color Functions Component
description: Canvas component with accessibility color functions for color blindness simulations, contrast checking, and luminance calculations
