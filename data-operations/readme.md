...
> Power Fx snippets for data manipulation, processing, and transformation operations including sample datasets, data sources, and common data handling patterns in Power Apps.

## 📋 Overview

This category focuses on data operations and manipulation in Power Apps. It includes sample datasets for testing, data source configurations, schema definitions, and patterns for processing, transforming, and working with data from various sources.

### When to Use
- ✅ **Use this category when**: Working with data processing, sample datasets, data source connections, or data transformation logic
- ✅ **Best for**: Data analysts, developers integrating with external systems, and those building data-driven applications
...
- **🏷️ Primary Tags**: `#data-operations` `#samples` `#sources` `#schemas` `#processing` `#transformation`
...
### By Technology
- **CSV**: [View all CSV datasets](#csv-datasets)
- **JSON**: [View all JSON schemas](#json-schemas)
- **SQL**: [View all SQL sources](#sql-sources)

### By Use Case
- **Testing**: [View test datasets](#test-data)
- **Business**: [View business data](#business-data)
- **Geographic**: [View location data](#location-data)

### By Feature
- **Schemas**: [View data schemas](#data-schemas)
- **Samples**: [View sample data](#sample-data)
- **Sources**: [View data sources](#data-sources)
...
- [**Power Fx Basics**](https://learn.microsoft.com/en-us/power-platform/power-fx/overview) - Data operations
- [**Data Sources**](https://learn.microsoft.com/en-us/power-apps/maker/canvas-apps/connections-list) - Connection fundamentals
...
- Updated examples for data processing
- Added cross-references to data sources
